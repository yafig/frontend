...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"q/G0Eh7AmU?token=HoyqjBs1mE9itMb1TO7aZw","method":"post","propertyName":"token"},"logout":false,"user":{"url":"q/G0Eh7AmU?token=HoyqjBs1mE9itMb1TO7aZw","method":"get","propertyName":"user_name"}},"_name":"local"}))
